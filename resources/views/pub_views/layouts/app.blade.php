            ...
            <div class="container topbar bg-primary d-none d-lg-block">
                <div class="d-flex justify-content-between">
                    <div class="top-info ps-2">
                        ...
                        <small class="me-3"><i class="fas fa-address-card me-2 text-secondary"></i><a href="#" class="text-white">Reg. No : SW/MOA/24750</a></small>
                    </div>
                ...
                <nav class="navbar navbar-light bg-white navbar-expand-xl">
                    ...
                    <div class="collapse navbar-collapse bg-white" id="navbarCollapse">
                        <div class="navbar-nav mx-auto">
                            ...
                            <a href="shop-detail.html" class="nav-item nav-link">Service</a>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-6 text-center text-md-start mb-3 mb-md-0">
                        <span class="text-light"><a href="{{ route('home') }}"><i class="fas fa-copyright text-light me-2"></i>Bagrow Company LTD</a>, All right reserved.</span>
                    </div>
